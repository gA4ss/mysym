...
namespace mysym
{
  ...
  static list_t __filter(const symbol_t &s, fptr_filter_found_t fptr)
  {
    list_t l;
  ...
  {
    return __filter(s, __is_variable);
  }
  ...
  {
    return __filter(s, __is_constant);
  }
  ...
  {
    return __filter(s, __is_integer);
  }
  ...
  {
    return __filter(s, __is_fraction);
  }
